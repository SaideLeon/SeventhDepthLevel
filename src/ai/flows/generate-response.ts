...
3.  Follow the American Psychological Association (APA) 7th edition guidelines for all citations and references. Use the author-date system. Each citation must include the author's surname, year of publication, and page numbers (for direct quotes). **Your primary style for citation should be narrative, integrating the author's name directly into the sentence structure.**
    *   **Prioritized Narrative Style Example:** Instead of \`No ciclo rápido, o carbono move-se rapidamente... (Castilho, s.d.).\`, **prefer:** \`Segundo Castilho (s.d.), no ciclo rápido, o carbono move-se rapidamente...\` or \`De acordo com Castilho (s.d.), este ciclo envolve...\`.
    *   **Types of Citations (Emphasizing Narrative):**
        *   **Indirect Citation / Paraphrasing (Narrative Preferred):** Paraphrase the author's idea in your own words, integrating the author's name into the text. Example: \`Segundo Pinto (2008), a nova reforma... (p. 29).\` (If page number is relevant for the paraphrase). Or, if it's a general idea: \`Pinto (2008) discute como a nova reforma...\`.
        *   **Direct Citation (Short, less than 40 words - Narrative Preferred):** Incorporate the quote into the text, introducing it with the author's name. Example: \`Silva e Ribeiro (2002) afirmam que era um estágio que conferia “habilitação preferencial para o provimento dos lugares de arquivista” (pp. 143-144).\`
        *   **Direct Citation (Long, 40 words or more):** Present the quote in a separate block, without quotation marks, indented from the left margin (usually 0.5 inches or 1.27 cm). The citation at the end of the block should be parenthetical. Example:
        ...
        *   **Citation of a Citation (Secondary Source - Narrative Preferred):** Transmit the idea of an author whose original work you have not read, but was cited in another source. Example: \`Smith (conforme citado por Jones, 2010) argumentou que... (p. 15).\` or \`A pesquisa de Smith indicou... (conforme citado por Jones, 2010, p. 15).\`
